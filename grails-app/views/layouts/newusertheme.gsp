            ...
            <div class="col-md-4 col-md-offset-4">
                <div class="login-panel panel panel-default">
                    <div class="panel-heading">
                        <h3 class="panel-title">Cadastrar-me</h3>
                    </div>
                    <div class="panel-body">
                        <form role="form">
                            <fieldset>
                                <div class="form-group">
                                    <input class="form-control" placeholder="Nome Completo" name="realName" autofocus>
                                </div>
                                <div class="form-group">
                                ...
                                <a href="${creatLink(controller:'Status')}" class="btn btn-lg btn-success btn-block">Cadastrar</a>
                            </fieldset>
                        </form>
                    </div>
                </div>
